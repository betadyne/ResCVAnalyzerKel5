...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='YES',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://github.com/betadyne/ai-kelompok5" style="text-decoration: none; color: #dce3fc;">Kelompok 5</a></b>' 
        ...
        if pdf_file is not None:
            ...
            if resume_data:
                ...
                if 'EXPERIENCE' in resume_text:
                    ...
                    st.markdown('''<h5 style='text-align: left; color: #ffffff0;'>[-] Please add Experience. It will help you to stand out from crowd</h4>''',unsafe_allow_html=True)
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align='justify'>
            Tools yang membantu menganalisis resume menggunakan NLP dan menemukan kata kunci, kemudian mengelompokkannya berdasarkan sektor. Setelah itu, tools ini bisa memberikan rekomendasi, prediksi, dan analisis kepada pelamar berdasarkan kesesuaian kata kunci.
        </p>

        <p align="justify">
            <b>Cara Menggunakan: -</b> <br/><br/>
            <b>User -</b> <br/>
            Di Sidebar, pilih opsi User, isi detail yang diperlukan, dan unggah resume Anda dalam format PDF.<br/>
            Kemudian, biarkan tool ini bekerja.<br/><br/>
            <b>Feedback -</b> <br/>
            Anda juga dapat memberikan masukan tentang tool ini di sini.<br/><br/>
            <b>Admin -</b> <br/>
            Untuk login, gunakan <b>admin</b> sebagai username dan <b>admin@resume-analyzer</b> sebagai password.<br/>
            Tool ini akan menyiapkan segala yang diperlukan dan melakukan analisis.
        </p><br/><br/>

        <p align="justify">
            Built with 🤍 by 
            <p style="text-decoration: none; color: grey;">Kelompok 5 AI</p>
        </p>
                    
        <ul align="justify">
            <li>REVALINA RAMADHANI (09021182227007)</li>
            <li>CHIELLO FIELAYCIA (09021182227008)</li>
            <li>RETNO WARDANI (09021182227031)</li>
            <li>BINTANG ARDI NUGROHO (09021282227071)</li>
            <li>MOHAMMAD DIMAS ATTORIQ (09021282227106)</li>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Selamat Datang ! Total %d " % values + " User's yang telah menggunakan tool ini. : )")                
